...
/* synthesis syn_black_box black_box_pad_pin="i_rstn,i_instruction[31:0],i_instr_valid,i_array_data[7:0],o_array_data[7:0],o_array_address[31:0],o_wr_en,o_rd_en,o_Control_ready" */
/* synthesis syn_force_seq_prim="i_clk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 i_clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME i_clk, ASSOCIATED_RESET i_rstn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN System_Top_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input i_clk /* synthesis syn_isclock = 1 */;
  ...
  input i_instr_valid;
  input [7:0]i_array_data;
  output [7:0]o_array_data;
