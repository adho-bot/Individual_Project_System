...
module System_Top
  ...
  wire AXI_ArrayProc_0_o_instr_valid;
  wire [19:0]AXI_ArrayProc_0_o_instruction;
  wire BRAM_Wrapper_0_clkb;
  wire BRAM_Wrapper_0_enb;
  wire [31:0]BRAM_Wrapper_0_o_bram_addrb;
  wire [31:0]BRAM_Wrapper_0_o_bram_dinb;
  wire [3:0]BRAM_Wrapper_0_o_bram_web;
  wire [15:0]BRAM_Wrapper_0_o_top_rdata;
  wire BRAM_Wrapper_0_rstb;
  wire [14:0]DDR_addr;
  wire [2:0]DDR_ba;
  wire DDR_cas_n;
  wire DDR_ck_n;
  ...
  wire Top_0_o_Control_ready;
  wire [31:0]Top_0_o_array_address;
  ...
  System_Top_AXI_ArrayProc_0_0 AXI_ArrayProc_0
       (.i_fsm_ready(Top_0_o_Control_ready),
        .o_instr_valid(AXI_ArrayProc_0_o_instr_valid),
        .o_instruction(AXI_ArrayProc_0_o_instruction),
  ...
  System_Top_BRAM_Wrapper_0_0 BRAM_Wrapper_0
       (.clkb(BRAM_Wrapper_0_clkb),
        .enb(BRAM_Wrapper_0_enb),
        .i_bram_doutb(blk_mem_gen_0_doutb),
        .i_clk(processing_system7_0_FCLK_CLK0),
        .i_top_addr(Top_0_o_array_address),
        .i_top_rd_en(Top_0_o_rd_en),
        .i_top_wdata(Top_0_o_array_data),
        .i_top_wr_en(Top_0_o_wr_en),
        .o_bram_addrb(BRAM_Wrapper_0_o_bram_addrb),
        .o_bram_dinb(BRAM_Wrapper_0_o_bram_dinb),
        .o_bram_web(BRAM_Wrapper_0_o_bram_web),
        .o_top_rdata(BRAM_Wrapper_0_o_top_rdata),
        .rstb(BRAM_Wrapper_0_rstb));
  System_Top_Top_0_0 Top_0
       (.i_array_data(BRAM_Wrapper_0_o_top_rdata),
        .i_clk(processing_system7_0_FCLK_CLK0),
        .i_instr_valid(AXI_ArrayProc_0_o_instr_valid),
        .i_instruction(AXI_ArrayProc_0_o_instruction),
        .i_rstn(proc_sys_reset_0_peripheral_aresetn),
        .o_Control_ready(Top_0_o_Control_ready),
        .o_array_address(Top_0_o_array_address),
  ...
  System_Top_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        ...
        .dinb(BRAM_Wrapper_0_o_bram_dinb),
  ...
  (* BMM_INFO_PROCESSOR = "arm > System_Top axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  System_Top_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  System_Top_smartconnect_0_0 smartconnect_0
