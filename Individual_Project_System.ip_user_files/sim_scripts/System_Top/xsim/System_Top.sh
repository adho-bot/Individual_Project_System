...
export RDI_DATADIR="/opt/2025.2/data"
...
simulate()
{
  xsim System_Top -key {Behavioral:sim_1:Functional:System_Top} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_a752.protoinst" -protoinst "protoinst_files/System_Top.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/opt/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb System_Top.wdb xsim.dir libdpi.so)
